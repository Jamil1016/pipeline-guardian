...
Open-source reference implementation of the **ETL auto-remediation agent** pattern.

The production version of this system runs privately at my employer at the scale described on the portfolio case study:
https://jamilmendez.dev/projects/pipeline-guardian
...
**ETA:** Week W8 of the AI Engineer learning path
